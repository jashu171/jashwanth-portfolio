        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0">
            <button
              ...
              className="text-xl font-bold text-slate-600 hover:scale-105 transition-transform"
            >
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                    activeSection === item.id
                      ...
                      : "text-slate-500 hover:text-slate-600 hover:bg-gray-50"
                  }`}
                >
                  {item.label}
                </button>
          ...
          <div className="md:hidden">
            ...
            >
              <div className="w-6 h-6 flex flex-col justify-center items-center">
                ...
                />
                <span
                  className={`block w-5 h-0.5 bg-slate-600 mt-1 transition-all duration-200 ${
