...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-sky-50 to-cyan-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-sky-700 mb-6">
            About <span className="bg-gradient-to-r from-sky-500 to-cyan-600 bg-clip-text text-transparent">Me</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <Card className="p-6 border-none shadow-lg hover:shadow-xl transition-all duration-[2000ms] bg-white/80 backdrop-blur-sm border border-sky-100">
              <CardContent className="p-0">
                <h3 className="text-2xl font-bold text-sky-700 mb-4">My Journey</h3>
            ...
            <Card className="p-6 border-none shadow-lg hover:shadow-xl transition-all duration-[2000ms] bg-white/80 backdrop-blur-sm border border-sky-100">
              <CardContent className="p-0">
                <h3 className="text-2xl font-bold text-sky-700 mb-4">Education</h3>
                <div className="space-y-3">
                  <div>
                    <h4 className="font-semibold text-sky-700">B.Tech Computer Science (AI & ML)</h4>
                    <p className="text-sky-600">Expected Graduation: 2025</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          {/* Skills */}
          <div>
            <h3 className="text-2xl font-bold text-sky-700 mb-8">Technical Skills</h3>
            <div className="space-y-6">
              {skills.map((skill, index) => (
                <div key={skill.name} className="skill-item transition-all duration-[2000ms]" style={{ animationDelay: `${index * 200}ms` }}>
                  <div className="flex justify-between items-center mb-2">
                    <span className="font-medium text-sky-700">{skill.name}</span>
                    <span className="text-sm text-sky-600">{skill.level}%</span>
                  </div>
                  <div className="w-full bg-sky-100 rounded-full h-2">
                    <div
                      className="bg-gradient-to-r from-sky-400 to-cyan-600 h-2 rounded-full transition-all duration-[3000ms] ease-out"
