      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-slate-600 mb-6">
            About <span className="bg-gradient-to-r from-slate-500 to-slate-700 bg-clip-text text-transparent">Me</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <Card className="p-6 border-none shadow-lg hover:shadow-xl transition-all duration-[2000ms] bg-white/80 backdrop-blur-sm border border-gray-200">
              <CardContent className="p-0">
                <h3 className="text-2xl font-bold text-slate-600 mb-4">My Journey</h3>
            ...
            <Card className="p-6 border-none shadow-lg hover:shadow-xl transition-all duration-[2000ms] bg-white/80 backdrop-blur-sm border border-gray-200">
              <CardContent className="p-0">
                <h3 className="text-2xl font-bold text-slate-600 mb-4">Education</h3>
                <div className="space-y-3">
                  <div>
                    <h4 className="font-semibold text-slate-600">B.Tech Computer Science (AI & ML)</h4>
                    <p className="text-slate-500">Expected Graduation: 2025</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          {/* Skills */}
          <div>
            <h3 className="text-2xl font-bold text-slate-600 mb-8">Technical Skills</h3>
            <div className="space-y-6">
              {skills.map((skill, index) => (
                <div key={skill.name} className="skill-item transition-all duration-[2000ms]" style={{ animationDelay: `${index * 200}ms` }}>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      className="bg-gradient-to-r from-slate-400 to-slate-600 h-2 rounded-full transition-all duration-[3000ms] ease-out"
